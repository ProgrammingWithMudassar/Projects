    ...
    return (
        <div className='w-full bg-white-cool/10 items-center bg-white-600'>
            {data?.map((user: InternalUser) => (
                <div key={user.id} className='w-full h-[35px] grid grid-cols-[1fr,1fr,1.5fr,2fr,0.5fr] justify-center items-center border-b-[1px] border-b-white-cool/10 px-4'>
                    <p className='w-[100px] md:w-[20%] text-black-600 text-[13px] capitalize whitespace-nowrap'>{user.first_name}</p>
                    <p className='w-[100px] md:w-[20%] text-black-600 text-[13px] capitalize whitespace-nowrap'>{user.last_name}</p>
                    <p className='w-[100px] md:w-[20%] text-black-600 text-[13px] whitespace-nowrap'>{user.email}</p>
                    <p className='w-[100px] md:w-[40%] text-black-600 text-[13px] capitalize whitespace-nowrap'>{user.hq_location}</p>
                    <p className='w-[100px] md:w-[20%] text-black-600 text-[13px] text-center whitespace-nowrap'>
